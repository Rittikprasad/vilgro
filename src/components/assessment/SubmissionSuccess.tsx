...
const SubmissionSuccess: React.FC = () => {
  ...
  // Fetch user profile if organization is missing
  useEffect(() => {
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                ...
                <div className="flex items-start space-x-4 mb-8">
                  ...
                  <div className="flex-1">
                    {isEligible ? (
                      <p className="text-[15px] font-[400] text-gray-700 text-justify">
                ...
                <div className="mt-8 text-gray-600 text-[13px] font-[300]">
                  <p>
                    <span className="font-bold">Disclaimer:</span> This tool provides indicative financing suggestions based solely on user inputs. It is not exhaustive or definitive advice.
                  </p>
                </div>
              </div>
            </div>
                        ...
                        {Object.entries(eligibility.details.sections).map(([sectionName, sectionData]) => (
                          <div key={sectionName} className="border-l-4 border-green-500 pl-4">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span
                                className={`text-xs px-2 py-0.5 rounded ${sectionData.gate_pass
                                  ? 'bg-green-100 text-green-700'
                                  : 'bg-red-100 text-red-700'
                                  }`}
                              >
                                {sectionData.gate_pass ? 'Pass' : 'Below the passing threshold'}
                              </span>
                            </div>
